        ...
        <div class="row">
            ...
            ?>
                        ...
                        <?php
                            ...
                            if(!$total_pages):
                                echo '<span style="color:red;font-size: 23px;text-align: center;display: block;">Няма намерени резултати!</span>';
                            else:
                            foreach ($result as $row) {
                                ?>
                                <div class="col-md-3 item item-search-result">
                                    <div class="inner">
                                        ...
                                        <div class="text">
                                            ...
                                            <h4>
                                                <?php echo $row['p_current_price']; ?>лв.
                                            ...
                                            <?php else: ?>
                                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>">Добави в кошницата</a></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
