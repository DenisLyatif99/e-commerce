...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = 'Съжаляваме! Има само '.$current_p_qty.' артикул(и) на склад';
		?>
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Този продукт вече е добавен в кошницата.';
        } else {
            ...
            $success_message1 = 'Продуктът е добавен в кошницата успешно!';
        }
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation"><a href="#description" aria-controls="description" role="tab" data-toggle="tab"><?php echo LANG_VALUE_59; ?></a></li>
                                    ...
                                    <div class="review-form">
                                        ...
                                        <?php if(isset($_SESSION['customer'])): ?>
                                            ...
                                            <div class="form-group">
                                                <textarea name="comment" class="form-control" cols="30" rows="10" placeholder="Напишете своя коментар (по избор)" style="height:100px;"></textarea>
                                            </div>
