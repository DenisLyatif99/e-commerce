                ...
                <div class="row">
		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
                                ...
                                Трябва да попълните цялата информация за доставка от таблото за управление, за да поръчате. Моля, попълнете информацията на <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">този линк</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="<?php echo"Поръчай" ?>" name="form3">
                                        </div>
                                    </form>
