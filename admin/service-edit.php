...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
	    ...
	    $success_message = 'Услугата е актуализирана успешно!';
	}
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактирай услуга</h1>
	</div>
	<div class="content-header-right">
		<a href="service.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Заглавие<span>*</span></label>
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="title" value="<?php echo $title; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Съдържание<span>*</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-6" style="padding-top:5px">
								<input type="file" name="photo">(jpg, jpeg, gif и png)
							</div>
						</div>	
						<div class="form-group">
