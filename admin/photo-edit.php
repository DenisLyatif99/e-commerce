...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['caption'])) {
        $valid = 0;
        $error_message .= "Описанието на снимката не може да бъде празно поле<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Снимката е актуализирана успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">с
		<h1>Редактирай снимки</h1>
	</div>
	<div class="content-header-right">
		<a href="photo.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Описание на снимка<span>*</span></label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="caption" value="<?php echo $caption; ?>">
							</div>
						</div>
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Съществуваща основна снимка</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Качи нова снимка<span>*</span></label>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Качи</button>
							</div>
						</div>
					</div>
				</div>
