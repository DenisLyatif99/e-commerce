...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Главната категория не може да бъде празна<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Главната категория вече съществува<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Главната категория е добавена успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактиране на главна категория</h1>
	</div>
	<div class="content-header-right">
		<a href="top-category.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Име на категорията<span>*</span></label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="tcat_name" value="<?php echo $tcat_name; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Показване в меню?<span>*</span></label>
                    <div class="col-sm-4">
                        <select name="show_on_menu" class="form-control" style="width:auto;">
                            <option value="0" <?php if($show_on_menu == 0) {echo 'selected';} ?>>Не</option>
                            <option value="1" <?php if($show_on_menu == 1) {echo 'selected';} ?>>Да</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
