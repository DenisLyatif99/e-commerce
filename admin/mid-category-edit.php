...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Mid Level Category Name can not be empty Средната категория не може да бъде празно поле<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Средната категория е актуализирана успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактирай средната категория</h1>
	</div>
