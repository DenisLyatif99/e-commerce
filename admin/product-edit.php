...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Трябва да изберете главна категория<br>";
    }

    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "Трябва да изберете средна категория<br>";
    }

    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Трябва да изберете крайна категория<br>";
    }

    if(empty($_POST['p_name'])) {
        $valid = 0;
        $error_message .= "Името на продукта не може да бъде празно поле<br>";
    }

    if(empty($_POST['p_current_price'])) {
        $valid = 0;
        $error_message .= "Цената на продукта не може да бъде празно поле<br>";
    }

    if(empty($_POST['p_qty'])) {
        $valid = 0;
        $error_message .= "Количеството не може да бъде празно поле<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Продукта е актуализиран успешно.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="mcat_id" class="form-control select2 mid-cat">
		                            <option value="">Изберете средна категория</option>
		                            <?php
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
		                            <option value="">Изберете крайна категория</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Име на продукт<span>*</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_name" class="form-control" value="<?php echo $p_name; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Стара цена<br><span style="font-size:10px;font-weight:normal;">(лв)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Настояща цена<span>*</span><br><span style="font-size:10px;font-weight:normal;">(лв)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Избери размер</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Избери цвят</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Съществуваща основна снимка</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Смени основна снимка</label>
							<div class="col-sm-4" style="padding-top:4px;">
								<input type="file" name="p_featured_photo">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Други снимки</label>
							<div class="col-sm-4" style="padding-top:4px;">
							...
							<div class="col-sm-2">
			                    <input type="button" id="btnAddNew" value="Добави" style="margin-top: 5px;margin-bottom:10px;border:0;color: #fff;font-size: 14px;border-radius:3px;" class="btn btn-warning btn-xs">
			                </div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Обнови</button>
							</div>
						</div>
					</div>
				</div>
