...
if(isset($_POST['form1'])) {
    ...
    if($path == '') {
        $valid = 0;
        $error_message .= 'Трябва да изберете снимка<br>';
    } else {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Логото е актуализирано успешно.';
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Favicon е актуализирано успешно.';
...
if(isset($_POST['form3'])) {
    ...
    $success_message = 'Общите настройки за съдържание са актуализирани успешно.';
...
if(isset($_POST['form4'])) {
    ...
    $success_message = 'Информацията за настройките на формуляра за контакт е актуализирана успешно.';
}
...
if(isset($_POST['form5'])) {
    ...
    $success_message = 'Настройките на страничната лента са актуализирани успешно.';
}
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'Раздел Настройки за включване-изключване е актуализиран успешно.';
}
...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'Home Meta настройките са актуализирани успешно.';
}
...
if(isset($_POST['form6_7'])) {
    ...
    if(empty($_POST['cta_title'])) {
        $valid = 0;
        $error_message .= 'Заглавието не може да бъде празно<br>';
    }

    if(empty($_POST['cta_content'])) {
        $valid = 0;
        $error_message .= 'Съдържанието не може да бъде празно<br>';
    }

    if(empty($_POST['cta_read_more_text'])) {
        $valid = 0;
        $error_message .= 'Прочетете повече Текстът не може да бъде празен<br>';
    }

    if(empty($_POST['cta_read_more_url'])) {
        $valid = 0;
        $error_message .= 'Прочетете повече URL адресът не може да бъде празен<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Данните са актуализирани успешно.';
...
if(isset($_POST['form6_4'])) {
    ...
    if(empty($_POST['featured_product_title'])) {
        $valid = 0;
        $error_message .= 'Заглавието на избрания продукт не може да бъде празно<br>';
    }

    if(empty($_POST['featured_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Подзаглавието на избрания продукт не може да бъде празно<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Данните за представените продукти са актуализирани успешно.';
...
if(isset($_POST['form6_5'])) {
    ...
    if(empty($_POST['latest_product_title'])) {
        $valid = 0;
        $error_message .= 'Заглавието на последния продукт не може да бъде празно<br>';
    }

    if(empty($_POST['latest_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Подзаглавието на последния продукт не може да бъде празно<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Последните данни за продукта са актуализирани успешно.';
...
if(isset($_POST['form6_6'])) {
    ...
    if(empty($_POST['popular_product_title'])) {
        $valid = 0;
        $error_message .= 'Заглавието на популярния продукт не може да бъде празно<br>';
    }

    if(empty($_POST['popular_product_subtitle'])) {
        $valid = 0;
        $error_message .= 'Подзаглавието на популярния продукт не може да бъде празно<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Данните за популярни продукти са актуализирани успешно.';
...
if(isset($_POST['form6_3'])) {
        ...
        $success_message = 'Текстът на бюлетина е актуализиран успешно.';
...
if(isset($_POST['form7_1'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата за вход е актуализиран успешно.';
...
if(isset($_POST['form7_2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата за регистрация е актуализиран успешно.';
...
if(isset($_POST['form7_3'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата за забравена парола е актуализиран успешно.';
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата за нулиране на парола е актуализиран успешно.';
...
if(isset($_POST['form7_6'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата за търсене е актуализиран успешно.';
...
if(isset($_POST['form7_7'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата на кошницата е актуализиран успешно.';
...
if(isset($_POST['form7_8'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата за плащане е актуализиран успешно.';
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Банерът на страницата с категория на продукта е актуализиран успешно.';
...
if(isset($_POST['form9'])) {
    ...
    $success_message = 'Настройките за плащане са актуализирани успешно.';
}
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Head and Body Script е актуализиран успешно.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_1" data-toggle="tab">Лого</a></li>
                        <li><a href="#tab_2" data-toggle="tab">Favicon</a></li>
                        <li><a href="#tab_3" data-toggle="tab">Footer и Контакти</a></li>
                        <li><a href="#tab_4" data-toggle="tab">Настройки за съобщения</a></li>
                        <li><a href="#tab_5" data-toggle="tab">Продукти</a></li>
                        <li><a href="#tab_6" data-toggle="tab">Настройки Начална страница</a></li>
                        <li><a href="#tab_7" data-toggle="tab">Настройки банер</a></li>
                        <li><a href="#tab_9" data-toggle="tab">Настройки плащания</a></li>
                        <li><a href="#tab_10" data-toggle="tab">Head & Body скриптове</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form1">Обнови логото</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">Обнови Favicon</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Раздел за бюлетин</label>
                                        <div class="col-sm-3">
                                            <select name="newsletter_on_off" class="form-control" style="width:auto;">
                                                <option value="1" <?php if($newsletter_on_off == 1) {echo 'selected';} ?>>Вкл.</option>
                                                <option value="0" <?php if($newsletter_on_off == 0) {echo 'selected';} ?>>Изкл.</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Адрес за контакт</label>
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="contact_address" style="height:140px;"><?php echo $contact_address; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Имейл за връзка</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="contact_email" value="<?php echo $contact_email; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Телефон за връзка</label>
                                        <div class="col-sm-6">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <button type="submit" class="btn btn-success pull-left" name="form4">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Начална страница (Колко представени продукта?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_featured_product_home" value="<?php echo $total_featured_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Начална страница (Колко най-нови продукт?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_latest_product_home" value="<?php echo $total_latest_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Начална страница (Колко популярни продукти?)<span>*</span></label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form5">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_6">
                        	...
                        	<h3>Секции Включени и Изключени</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Секция услуги</label>
                                        <div class="col-sm-4">
                                            <select name="home_service_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_service_on_off == 1) {echo 'selected';} ?>>Вкл.</option>
                                            	<option value="0" <?php if($home_service_on_off == 0) {echo 'selected';} ?>>Изкл.</option>
                                            </select>
                                        </div>
                                    </div>      
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Секция добре дошли</label>
                                        <div class="col-sm-4">
                                            <select name="home_welcome_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_welcome_on_off == 1) {echo 'selected';} ?>>Вкл.</option>
                                            	<option value="0" <?php if($home_welcome_on_off == 0) {echo 'selected';} ?>>Изкл.</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Секция за представени продукти</label>
                                        <div class="col-sm-4">
                                            <select name="home_featured_product_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_featured_product_on_off == 1) {echo 'selected';} ?>>Вкл.</option>
                                            	<option value="0" <?php if($home_featured_product_on_off == 0) {echo 'selected';} ?>>Изкл.</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Секция последни продукти</label>
                                        <div class="col-sm-4">
                                            <select name="home_latest_product_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_latest_product_on_off == 1) {echo 'selected';} ?>>Вкл.</option>
                                            	<option value="0" <?php if($home_latest_product_on_off == 0) {echo 'selected';} ?>>Изкл.</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Секция популярни продукти</label>
                                        <div class="col-sm-4">
                                            <select name="home_popular_product_on_off" class="form-control" style="width:auto;">
                                            	<option value="1" <?php if($home_popular_product_on_off == 1) {echo 'selected';} ?>>Вкл.</option>
                                            	<option value="0" <?php if($home_popular_product_on_off == 0) {echo 'selected';} ?>>Изкл.</option>
                                            </select>
                                        </div>
                                    </div>
                                   <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_0">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Секция основни продукти</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Заглавие на избрания продукт<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="featured_product_title" value="<?php echo $featured_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Подзаглавие на избрания продукт<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_4">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3>Секция последни продукти</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Заглавие на продукт<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="latest_product_title" value="<?php echo $latest_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Подзаглавие на продукт<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_5">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3>Секция популярни продукти</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Заглавие на популярен продукт<span>*</span></label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="popular_product_title" value="<?php echo $popular_product_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Подзаглавие на популярни продукти<span>*</span></label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_6">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3>Раздел за бюлетин</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Текст на бюлетин</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form6_3">Актуализирай</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Съществуващ банер на страницата за вход</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_login; ?>" alt="" style="width: 100%;height:auto;"> 
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата за вход</h4>
                                        Избери снимка<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Банер на съществуваща страница за регистрация</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_registration; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата за регистрацияr</h4>
                                        Избери снимка<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Съществуващ банер за страница за забравена парола</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_forget_password; ?>" alt="" style="width: 100%;height:auto;">   
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата за забравена парола</h4>
                                        Избери снимка<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Съществуващ банер за страница за нулиране на парола</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_reset_password; ?>" alt="" style="width: 100%;height:auto;">   
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата за нулиране на парола</h4>
                                        Избери снимка<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Съществуващ банер на страницата за търсене</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_search; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата за търсене</h4>
                                        Избери снимка<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Съществуващ банер на страницата на количката</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_cart; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата на количката</h4>
                                        Избери снимка<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Съществуващ банер на страницата за плащане</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_checkout; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата за плащане</h4>
                                        Избери снимка<input type="file" name="photo">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Банер на съществуваща продуктова категория</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_product_category; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Промяна на банера на страницата с категория на продукта</h4>
                                        Избери снимка<input type="file" name="photo">
                        ...
                        <div class="tab-pane" id="tab_9">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">PayPal - бизнес имейл </label>
                                            <div class="col-sm-5">
                                      ...
                                      <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Банкова информация</label>
                                            <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left" name="form9">Актуалиризай</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label"></label>
                                            <div class="col-sm-6">
                                                <button type="submit" class="btn btn-success pull-left" name="form10">Актуализирай</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
