	...
	<script>
	  $(function () {
	    ...
	    {
	        return confirm("Сигурни ли сте че искате да изтриете датата?");
	    }
	    function confirmActive()
	    {
	        return confirm("Сигурни ли сте че искате да сте активни?");
	    }
	    function confirmInactive()
	    {
	        return confirm("Сигурни ли сте че искате да сте неактивни?");
	    }
