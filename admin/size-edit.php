...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
        $valid = 0;
        $error_message .= "Името на размера не може да бъде празно<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Името на размера вече съществува<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Размерът е актуализиран успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактиране на размера</h1>
	</div>
	<div class="content-header-right">
		<a href="size.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Име на размер<span>*</span></label>
                    <div class="col-sm-4">
