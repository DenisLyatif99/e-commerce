...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$success_message = 'Слайдъра е добавен успешно!';
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Снимка<span>*</span></label>
							<div class="col-sm-9" style="padding-top:5px">
								<input type="file" name="photo">(Само jpg, jpeg, gif и png файлове)
							</div>
						</div>
						<div class="form-group">
