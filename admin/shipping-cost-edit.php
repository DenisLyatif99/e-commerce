...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Държавата вече съществува в системата<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Цената за доставка е актуализирана успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактиране на разходите за доставка</h1>
	</div>
	<div class="content-header-right">
		<a href="shipping-cost.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
        ...
        <form class="form-horizontal" action="" method="post">
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Количество<span>*</span></label>
                        <div class="col-sm-4">
