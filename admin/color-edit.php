...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['color_name'])) {
        $valid = 0;
        $error_message .= "Цвета не може да бъде празно поле<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Цвета съществува в системата<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Цвета е актуализиран успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактирай цвят</h1>
	</div>
	<div class="content-header-right">
		<a href="color.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Име на цвят<span>*</span></label>
                    <div class="col-sm-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Потвърди изтриването</h4>
            </div>
