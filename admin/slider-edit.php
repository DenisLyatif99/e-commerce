...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
	    ...
	    $success_message = 'Слайдъра е актуализиран успешно!';
	}
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактиране на слайдъра</h1>
	</div>
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Виж всички</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Снимка</label>
							<div class="col-sm-6" style="padding-top:5px">
								<input type="file" name="photo">(Само jpg, jpeg, gif и png са позволени)
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Заглавие</label>
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="heading" value="<?php echo $heading; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Съдържание</label>
							<div class="col-sm-6">
								<textarea class="form-control" name="content" style="height:140px;"><?php echo $content; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Текст на бутона</label>
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="button_text" value="<?php echo $button_text; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">URL адрес на бутона</label>
							<div class="col-sm-6">
								<input type="text" autocomplete="off" class="form-control" name="button_url" value="<?php echo $button_url; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Позиция</label>
							<div class="col-sm-6">
								<select name="position" class="form-control">
									<option value="Left" <?php if($position == 'Left') {echo 'selected';} ?>>Ляво</option>
									<option value="Center" <?php if($position == 'Center') {echo 'selected';} ?>>Център</option>
									<option value="Right" <?php if($position == 'Right') {echo 'selected';} ?>>Дясно</option>
								</select>
							</div>
						</div>				
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Актуализирай</button>
							</div>
						</div>
					</div>
				</div>
