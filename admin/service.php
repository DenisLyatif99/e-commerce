...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="service-add.php" class="btn btn-primary btn-sm">Добави услуга</a>
	</div>
</section>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td>										
										<a href="service-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">Обнови</a>
										<a href="#" class="btn btn-danger btn-xs" data-href="service-delete.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete">Изтрий</a>  
									</td>
								</tr>
								<?php
							}
