...
if(isset($_POST['form1'])) {
    ...
    for($i=1;$i<=count($arr1);$i++) {
        ...
        if($table_quantity[$temp_index] < $arr2[$i]) {
        	$allow_update = 0;
            $error_message .= '"'.$arr2[$i].'" бройки не са налични за "'.$arr3[$i].'"\n';
        } else {
	...
	<?php else: ?>
		<script>alert('Актуализирането на количеството на всички артикули е успешно!');</script>
	<?php endif; ?>
    <?php
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    <?php echo '<h2 class="text-center">Кошницата е празна!</h2></br>'; ?>
                    <?php echo '<h4 class="text-center">Добавете продукти в кошницата, за да ги видите тук.</h4>'; ?>
                <?php else: ?>
				...
				<div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <?php endfor; ?>
                        <tr>
                            <th colspan="7" class="total-text">Общо</th>
