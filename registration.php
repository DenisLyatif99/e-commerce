...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $verify_link = BASE_URL.'https://prestigeprize.com/verify.php?email='.$to.'&token='.$token;
        $message = '
'.LANG_VALUE_151.'<br><br>

<a href="'.$verify_link.'">Кликнете тук</a>';

        $headers = "From: prestigeprize@gmail.com\r\n" .
                   "Reply-To: prestigeprize@gmail.com\r\n" .
