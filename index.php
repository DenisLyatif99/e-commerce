                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <?php else: ?>
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"></i>Добави в кошницата</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <?php else: ?>
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"></i>Добави в количката</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
