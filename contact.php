...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Моля въведете вашето име.\n';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Моля, въведете вашия телефонен номер.\n';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Моля, въведете вашия имейл адрес.\n';
    }
    else
    {
    ...
    {
        $valid = 0;
        $error_message .= 'Моля, въведете вашето съобщение.\n';
    }
...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="visitor_name" placeholder="Въведете име">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Имейл адрес</label>
                                        <input type="email" class="form-control" name="visitor_email" placeholder="Въведете имейл адрес">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Телефонен номер</label>
                                        <input type="text" class="form-control" name="visitor_phone" placeholder="Въведете телефонен номер">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Съобщение</label>
                                        <textarea name="visitor_message" class="form-control" rows="9" cols="25" placeholder="Въведете съобщение"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <input type="submit" value="Изпрати" class="btn btn-primary pull-right" name="form_contact">
                                </div>
                            </div>
                            </form>
                        </div>
                    ...
                    <div class="col-md-4">
                        <legend><span class="glyphicon glyphicon-globe"></span> Кореспонденция</legend>
                        <address>
                            <?php echo nl2br($contact_address); ?>
                        </address>
                        <address>
                            <strong>Телефонен номер:</strong><br>
                            <span><?php echo $contact_phone; ?></span>
                        </address>
                        <address>
                            <strong>Имейл адрес:</strong><br>
